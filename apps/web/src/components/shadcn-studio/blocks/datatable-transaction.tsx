...
import { Pagination, PaginationContent, PaginationEllipsis, PaginationItem } from '@tanisya/ui/components/pagination'
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@tanisya/ui/components/table'
