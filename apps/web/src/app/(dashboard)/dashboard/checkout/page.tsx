...
// 		name: "BRI",
// 		logoUrl:
// 			"https://upload.wikimedia.org/wikipedia/commons/6/68/BANK_BRI_logo.svg",
// 		fee: {
// 			pct: 0,
// 			flat: 4_000,
// 			vatInclusive: false,
...
// 		name: "BSI",
// 		logoUrl:
// 			"https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Bank_Syariah_Indonesia.svg/1920px-Bank_Syariah_Indonesia.svg.png",
// 		fee: {
// 			pct: 0,
// 			flat: 4_000,
// 			vatInclusive: false,
...
// 		name: "CIMB Niaga",
// 		logoUrl:
// 			"https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/CIMB_Niaga_logo.svg/1920px-CIMB_Niaga_logo.svg.png",
// 		fee: {
// 			pct: 0,
// 			flat: 4_000,
// 			vatInclusive: false,
...
// 		name: "PermataBank",
// 		logoUrl:
// 			"https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Permata_Bank_%282024%29.svg/1920px-Permata_Bank_%282024%29.svg.png",
// 		fee: {
// 			pct: 0,
// 			flat: 4_000,
// 			vatInclusive: false,
...
// 		name: "Bank BJB",
// 		logoUrl:
// 			"https://upload.wikimedia.org/wikipedia/id/thumb/4/41/Bank_BJB_logo.svg/960px-Bank_BJB_logo.svg.png",
// 		fee: {
// 			pct: 0,
// 			flat: 4_000,
// 			vatInclusive: false,
...
// 		name: "Bank Sampoerna",
// 		logoUrl:
// 			"https://upload.wikimedia.org/wikipedia/id/1/14/Bank_Sahabat_Sampoerna_logo.png",
// 		fee: {
// 			pct: 0,
// 			flat: 4_000,
// 			vatInclusive: false,
...
// 		name: "ShopeePay",
// 		logoUrl:
// 			"https://shopeepay.co.id/src/pages/home/assets/images/new-homepage/new-spp-logo.svg",
// 		fee: {
// 			pct: 1.8,
// 			flat: 0,
// 			vatInclusive: true,
// 			note: "MDR 1,8% (sudah inklusif PPN)",
// 		},
// 	},
// 	{
// 		id: "dana",
...
// 			flat: 0,
// 			vatInclusive: true,
// 			note: "MDR 0,63% (sudah inklusif PPN)",
// 		},
// 	},
// 	{
// 		id: "indomaret",
...
// 		name: "Indomaret",
// 		logoUrl:
// 			"https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Indomaret.svg/1920px-Indomaret.svg.png",
// 		fee: {
// 			pct: 0,
// 			flat: 8_325,
// 			vatInclusive: true,
// 			note: "Biaya Rp 7.500 + PPN 11%",
// 		},
// 	},
// 	{
// 		id: "alfamart",
...
// 		name: "Alfamart",
// 		logoUrl:
// 			"https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Alfamart_logo.svg/1920px-Alfamart_logo.svg.png",
// 		fee: {
// 			pct: 0,
// 			flat: 8_325,
// 			vatInclusive: true,
...
// 		name: "Visa",
// 		logoUrl:
// 			"https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Visa_Inc._logo_%282021%E2%80%93present%29.svg/1920px-Visa_Inc._logo_%282021%E2%80%93present%29.svg.png",
// 		fee: {
// 			pct: 3.33,
// 			flat: 4_995,
// 			vatInclusive: true,
// 			note: "3% + Rp 4.500 (sudah inklusif PPN)",
// 		},
// 	},
// 	{
// 		id: "mastercard",
...
// 		name: "Mastercard",
// 		logoUrl:
// 			"https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Mastercard-logo.svg/1920px-Mastercard-logo.svg.png",
// 		fee: {
// 			pct: 3.33,
// 			flat: 4_995,
// 			vatInclusive: true,
...
// 		name: "JCB",
// 		logoUrl:
// 			"https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/JCB_logo.svg/1920px-JCB_logo.svg.png",
// 		fee: {
// 			pct: 3.33,
// 			flat: 4_995,
// 			vatInclusive: true,
...
// 		logoUrl:
// 			"https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/American_Express_logo_%282018%29.svg/1920px-American_Express_logo_%282018%29.svg.png",
// 		fee: {
// 			pct: 4.44,
// 			flat: 4_995,
// 			vatInclusive: true,
// 			note: "4% + Rp 4.500 (sudah inklusif PPN)",
// 		},
// 	},
// ];
...
// }
// function supportsWhois(tld: string): boolean {
// 	return !WHOIS_UNSUPPORTED_TLDS.includes(tld);
// }
...
// 	const whoisAmt =
// 		supportsWhois(item.tld) && item.whoisEnabled
// 			? WHOIS_PROTECTION_PRICE * item.period
// 			: 0;
...
// 	if (item.type === "domain") return calcDomainSubtotal(item as any);
...
// 			)}
// 		>
// 			<div className="flex items-center gap-2.5 border-border/40 border-b px-5 py-3.5">
...
// function CompactPeriodSelector({
// 	value,
// 	onChange,
// }: {
// 	value: Period;
...
// 					className={cn(
// 						"flex items-center gap-1 rounded-lg border px-2.5 py-1.5 font-semibold text-xs transition-all",
// 						value === opt.value
...
// 						<span
// 							className={cn(
// 								"rounded-full px-1 font-bold text-[9px]",
// 								value === opt.value
...
// 	const effectiveName = contact.useAccountInfo
// 		? ACCOUNT_INFO.name
// 		: contact.name;
// 	const effectiveEmail = contact.useAccountInfo
// 		? ACCOUNT_INFO.email
// 		: contact.email;
// 	const effectivePhone = contact.useAccountInfo
// 		? ACCOUNT_INFO.phone
// 		: contact.phone;
...
// 				type="button"
// 				onClick={() => setOpen((v) => !v)}
// 				className="flex w-full items-center justify-between px-3 py-2.5 transition-colors hover:bg-muted/20"
// 			>
// 				<div className="flex min-w-0 items-center gap-2">
// 					<User className="h-3.5 w-3.5 shrink-0 text-muted-foreground" />
// 					<div className="min-w-0 text-left">
// 						<p className="truncate font-semibold text-xs">
// 							{effectiveName || "Informasi Kontak"}
// 						</p>
// 						<p className="truncate text-[10px] text-muted-foreground">
// 							{effectiveEmail || "Belum diisi"}
// 						</p>
// 					</div>
// 				</div>
// 				<ChevronDown
...
// 			{open && (
// 				<div className="space-y-3 border-border/30 border-t p-3">
// 					{/* Use account switch */}
...
// 							<div>
// 								<p className="font-semibold text-xs">Gunakan info akun</p>
...
// 						</div>
// 						<Switch
// 							checked={contact.useAccountInfo}
// 							onCheckedChange={handleUseAccount}
// 						/>
// 					</div>
...
// 	const discounted = Math.round(base * (1 - discount));
// 	const whoisAmt =
// 		tldOk && item.whoisEnabled ? WHOIS_PROTECTION_PRICE * item.period : 0;
// 	const sslAmt = item.sslPremium ? SSL_PREMIUM_PRICE * item.period : 0;
...
// 						Registrasi baru · {item.period} tahun
// 					</p>
// 				</div>
// 				<div className="flex shrink-0 items-center gap-2">
// 					<p className="font-bold text-sm">{formatIDR(subtotal)}</p>
// 					<button
// 						type="button"
...
// 			{/* Expandable settings */}
// 			{expanded && (
// 				<div className="space-y-3 border-border/30 border-t bg-muted/10 px-4 py-3">
// 					{/* Period */}
// 					<div>
// 						<p className="mb-1.5 font-semibold text-[10px] text-muted-foreground uppercase tracking-widest">
// 							Periode
// 						</p>
// 						<CompactPeriodSelector
// 							value={item.period}
// 							onChange={(p) => onChange({ ...item, period: p })}
// 						/>
// 						{discount > 0 && (
// 							<p className="mt-1 text-[11px] text-emerald-600">
// 								Hemat {formatIDR(Math.round(base * discount))} dari harga normal{" "}
// 								{formatIDR(base)}
// 							</p>
// 						)}
// 					</div>
...
// 											WHOIS Protection
// 											{!tldOk && (
// 												<span className="ml-1.5 rounded bg-muted px-1.5 py-0.5 font-medium text-[10px] text-muted-foreground">
...
// 										{tldOk ? (
// 											<p className="text-[11px] text-muted-foreground">
// 												Sembunyikan data WHOIS ·{" "}
// 												<span className="font-medium">
// 													+{formatIDR(WHOIS_PROTECTION_PRICE)}/thn
// 												</span>
// 											</p>
// 										) : (
// 											<p className="text-[11px] text-muted-foreground">
// 												Registry {item.tld} mewajibkan data WHOIS publik
// 											</p>
// 										)}
// 									</div>
// 								</div>
// 								<Switch
// 									checked={tldOk && item.whoisEnabled}
// 									onCheckedChange={
// 										tldOk
// 											? (v) => onChange({ ...item, whoisEnabled: v })
// 											: undefined
// 									}
// 									disabled={!tldOk}
// 								/>
...
// 									"flex items-center justify-between gap-3 rounded-lg border px-3 py-2.5 transition-colors",
// 									item.sslPremium
// 										? "border-emerald-300/50 bg-emerald-50/50 dark:border-emerald-800/30 dark:bg-emerald-950/20"
// 										: "border-border/40 bg-background",
// 								)}
// 							>
// 								<div className="flex min-w-0 items-center gap-2">
...
// 									/>
// 									<div className="min-w-0">
// 										<p className="font-semibold text-xs">SSL Premium</p>
// 										<p className="text-[11px] text-muted-foreground">
// 											Sertifikat SSL DV tervalidasi ·{" "}
// 											<span className="font-medium">
// 												+{formatIDR(SSL_PREMIUM_PRICE)}/thn
// 											</span>
// 										</p>
// 									</div>
// 								</div>
// 								<Switch
// 									checked={item.sslPremium}
// 									onCheckedChange={(v) => onChange({ ...item, sslPremium: v })}
// 								/>
// 							</div>
// 						</div>
// 					</div>
...
// 						productTypeBadgeColor(item.type),
// 					)}
// 				>
...
// 						</button>
// 						<span className="min-w-5 text-center font-bold text-xs">
// 							{item.quantity}
// 						</span>
// 						<button
// 							type="button"
...
// 			{expanded && (
// 				<div className="border-border/30 border-t bg-muted/10 px-4 py-3">
// 					<p className="mb-1.5 font-semibold text-[10px] text-muted-foreground uppercase tracking-widest">
// 						Periode
// 					</p>
// 					<CompactPeriodSelector
...
// 					{discount > 0 && (
// 						<p className="mt-1 text-[11px] text-emerald-600">
// 							Diskon {Math.round(discount * 100)}% untuk periode {item.period}{" "}
// 							tahun diterapkan
// 						</p>
// 					)}
// 				</div>
...
// 						type="button"
// 						onClick={onRemove}
// 						className="text-emerald-600 transition-colors hover:text-destructive"
// 					>
...
// 								className={cn(
// 									"h-8 flex-1 text-xs uppercase tracking-widest",
...
// 		cat,
// 		methods: PAYMENT_METHODS.filter((m) => m.category === cat),
// 	}));

// 	const selectedMethod = PAYMENT_METHODS.find((m) => m.id === selected) ?? null;

// 	const catIcon: Record<string, React.ReactNode> = {
// 		"Virtual Accounts": <span className="font-extrabold text-[10px]">VA</span>,
// 		"E-Wallet": <span className="font-extrabold text-[10px]">EW</span>,
// 		"QR Code": <span className="font-extrabold text-[10px]">QR</span>,
// 		Retail: <span className="font-extrabold text-[10px]">RT</span>,
...
// 					<a
// 						href="https://www.xendit.co/en-id/pricing/"
// 						target="_blank"
...
// 						Xendit
// 					</a>
// 					. Rincian biaya ditampilkan di ringkasan pesanan setelah memilih
// 					metode.
// 				</p>
// 			</div>
// 		</div>
...
// }) {
// 	// 1. Subtotal produk
// 	const subtotalProduk = items.reduce(
// 		(sum, item) => sum + getItemSubtotal(item),
// 		0,
// 	);

// 	// 2. Diskon promo
// 	const promoDisc = promoCode
// 		? Math.round(subtotalProduk * (promoCode.discount / 100))
// 		: 0;
...
// 		: null;
// 	const paymentFeeTotal = selectedMethod
// 		? calcTotalFee(selectedMethod, subtotalPajak)
// 		: 0;
...
// 								? WHOIS_PROTECTION_PRICE * item.period
// 								: 0;
// 						const sslAmt = item.sslPremium
// 							? SSL_PREMIUM_PRICE * item.period
// 							: 0;
// 						return (
...
// 										<span className="max-w-35 truncate font-medium font-mono">
// 											{full}
// 										</span>
...
// 										{formatIDR(domainPrice)}
// 									</span>
// 								</div>
// 								{discount > 0 && (
// 									<div className="flex items-center justify-between pl-5 text-[11px]">
// 										<span className="text-emerald-600">
// 											Diskon {Math.round(discount * 100)}%
// 										</span>
// 										<span className="text-emerald-600">
// 											−{formatIDR(Math.round(base * discount))}
// 										</span>
// 									</div>
// 								)}
// 								{whoisAmt > 0 && (
// 									<div className="flex items-center justify-between pl-5 text-[11px] text-muted-foreground">
// 										<span>+ WHOIS Protection</span>
// 										<span>{formatIDR(whoisAmt)}</span>
// 									</div>
// 								)}
// 								{sslAmt > 0 && (
// 									<div className="flex items-center justify-between pl-5 text-[11px] text-muted-foreground">
// 										<span>+ SSL Premium</span>
// 										<span>{formatIDR(sslAmt)}</span>
// 									</div>
// 								)}
// 							</div>
// 						);
...
// 					</div>
// 					<div className="flex items-center justify-between border-border/30 border-t pt-1.5 font-semibold text-sm">
// 						<span>Subtotal</span>
...
// 				{!paymentMethodId && (
// 					<p className="text-center text-amber-600 text-xs dark:text-amber-400">
...
// 	const handleCartFromUrl = React.useCallback((items: CartItem[]) => {
// 		setCartItems(items);
// 	}, []);
...
// 		(i) => i.type === "domain",
// 	) as DomainItem[];
// 	const genericItems = cartItems.filter(
// 		(i) => i.type !== "domain",
// 	) as GenericItem[];
...
// 				router.push(`/dashboard/order/payment?order=${data.orderId}` as any);
// 			},
// 		}),
// 	);
...
// 				<SearchParamsReader onCart={handleCartFromUrl} />
// 			</Suspense>
...
// 							Tinjau pesanan dan lengkapi informasi sebelum melanjutkan ke
// 							pembayaran.
// 						</p>
// 					</div>
// 				</div>
...
// 				{cartItems.length === 0 && (
// 					<div className="rounded-2xl border border-border/60 border-dashed bg-muted/10 px-6 py-16 text-center">
...
// 							<Link href="/dashboard">Jelajahi Produk</Link>
// 						</Button>
// 					</div>
// 				)}
...
// 									title={`Domain (${domainItems.length})`}
// 								>
// 									<div className="space-y-3">
// 										{domainItems.map((item) => (
// 											<DomainItemCard
...
// 												Setiap domain dapat dikonfigurasi secara terpisah:
// 												periode, add-on, dan informasi kontak registrant. WHOIS
// 												Protection tidak tersedia untuk domain{" "}
// 												<span className="font-mono">.id</span> dan ekstensi
// 												Indonesia lainnya.
// 											</p>
// 										</div>
// 									</div>
...
// 									title={`Produk Lainnya (${genericItems.length})`}
// 								>
// 									<div className="space-y-3">
// 										{genericItems.map((item) => (
// 											<GenericItemCard
...
// 												<Badge
// 													variant="secondary"
// 													className="ml-2 h-4 px-1.5 font-normal text-[10px] normal-case"
// 												>
// 													Opsional
// 												</Badge>
// 											</FieldLabel>
...
// 											/>
// 											<FieldDescription>
// 												Catatan ini hanya untuk referensi internal Anda.
// 											</FieldDescription>
// 										</Field>
// 									</FieldGroup>
// 								</FieldSet>
