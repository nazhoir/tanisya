            ...
            <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-primary via-primary/90 to-blue-600 text-primary-foreground shadow-xl shadow-primary/20 sm:rounded-3xl">
              ...
              <div className="relative flex flex-col gap-7 p-6 sm:p-10 lg:flex-row lg:items-start lg:gap-12 lg:p-16">
                ...
                <div className="flex w-full flex-col gap-2 lg:w-72 lg:shrink-0">
                  ...
                  <p className="pt-1 text-center text-xs font-semibold text-white/60">
                    + 43 aplikasi lainnya
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 lg:grid-cols-4">
              {FEATURES.map(({ icon: Icon, title, description }) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="mb-1 text-sm font-bold leading-tight sm:text-base">
                      {title}
                    </h3>
            ...
            <div className="mb-7 flex items-start justify-between gap-4 sm:mb-10 sm:items-end">
              <div>
                <div className="mb-2 flex flex-wrap items-center gap-2">
                  <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-violet-600 dark:text-violet-400">
                    Open Source
                  </p>
              ...
              <Link
                href="/oss"
                className="flex h-11 shrink-0 items-center gap-1 pl-4 text-xs font-semibold text-violet-600 hover:underline dark:text-violet-400 sm:text-sm"
              >
              ...
              {OSS_PROJECTS[0].items.map(
                ({ icon: Icon, badge, description, to, category, label }) => (
                  <Link
                    key={label}
                    href={to as any}
                    className="group flex items-start gap-4 rounded-2xl border border-violet-200/70 bg-background p-5 transition-all active:scale-[0.99] hover:border-violet-400/50 hover:shadow-md dark:border-violet-900/60 sm:flex-col sm:gap-4"
                  >
