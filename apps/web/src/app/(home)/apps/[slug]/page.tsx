        ...
        <div className="mx-auto max-w-5xl px-4 pb-16 pt-24">
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
            ...
            <div className="flex flex-1 items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                <div className="mb-2 flex flex-wrap items-center gap-2">
                  ...
                  <span className="flex items-center gap-1 rounded-full bg-yellow-50 border border-yellow-200 px-2 py-0.5 text-[11px] font-semibold text-yellow-700">
            ...
            <div className="flex shrink-0 flex-wrap gap-2 sm:flex-col">
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-1 rounded-xl bg-muted/50 px-3 py-2 text-xs text-muted-foreground">
      ...
      {app.preview && (
        <section className="mx-auto max-w-5xl px-4 py-8">
          <div className="overflow-hidden rounded-xl border border-border shadow-md">
            ...
            <div className="h-64 sm:h-80 md:h-96 overflow-hidden bg-muted/30">
