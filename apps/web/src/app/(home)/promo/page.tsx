...
function PromoCard({ promo }: { promo: PromoItem }) {
	...
	return (
		...
		>
			...
			<CardFooter className="flex-col items-stretch gap-3 px-5 pt-4 pb-5">
				<Button
					size="lg"
			...
			<section className="border-b bg-linear-to-b from-primary/10 to-background">
				<div className="mx-auto max-w-5xl px-4 pt-32 pb-16 text-center">
					...
					<p className="mx-auto max-w-xl text-base text-muted-foreground md:text-lg">
						Kumpulan promo eksklusif bagi pengguna baru maupun <br /> pelanggan
						setia.
					</p>
				</div>
			</section>
						...
						>
							<TabsList className="h-9">
								<TabsTrigger value="all" className="px-4 text-sm">
									...
									<Badge
										variant="secondary"
										className="ml-1.5 h-4 px-1.5 py-0 text-[10px]"
									>
										{PROMOS.length}
									</Badge>
								</TabsTrigger>
