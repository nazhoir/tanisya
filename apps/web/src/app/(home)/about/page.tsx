						...
						<div className="flex flex-col items-center text-center">
							...
							<div className="mb-5 inline-flex max-w-full items-center gap-2 rounded-full border border-primary/25 bg-primary/5 px-3 py-1.5 font-semibold text-primary text-xs sm:mb-6 sm:px-4 sm:text-sm">
								...
								<span className="truncate">
									Lahir di Surabaya · Melayani Seluruh Indonesia
								</span>
							</div>
							...
							<p className="mb-7 max-w-sm text-muted-foreground text-sm leading-relaxed sm:max-w-xl sm:text-base lg:text-lg">
								Tanisya lahir dari pengalaman nyata sebagai developer yang lelah
								dengan hosting lambat, support robot, dan biaya tersembunyi.
								Kami membangun platform yang ingin kami gunakan sendiri — dan
								sekarang lebih dari seribu bisnis mempercayakannya kepada kami.
							</p>
						...
						<div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
							<div>
								...
								<p className="mb-4 text-muted-foreground text-sm leading-relaxed sm:text-base">
									Kami percaya setiap bisnis — dari warung online hingga
									perusahaan menengah — berhak mendapatkan infrastruktur digital
									yang andal, terjangkau, dan mudah digunakan. Teknologi tidak
									boleh menjadi privilege eksklusif perusahaan besar.
								</p>
								<p className="text-muted-foreground text-sm leading-relaxed sm:text-base">
									Dengan Tanisya, UMKM di Makassar mendapat uptime dan keamanan
									yang sama dengan enterprise di Jakarta. Satu platform, satu
									standar, untuk semua.
								</p>
							</div>
									...
									{[
										{
											icon: Rocket,
											label: "Deploy Kilat",
											sub: "Aktif dalam menit",
										},
										{
											icon: Shield,
											label: "Keamanan Enterprise",
											sub: "SSL + WAF + DDoS",
										},
										{
											icon: Target,
											label: "Support Manusia",
											sub: "24/7 via WhatsApp",
										},
										{
											icon: Zap,
											label: "Infrastruktur Lokal",
											sub: "Data center Indonesia",
										},
				...
				<section className="py-12 sm:py-20 lg:py-28">
					<div className="mx-auto max-w-7xl px-4 sm:px-6">
						...
						<div className="relative mx-auto max-w-3xl">
							...
							<div className="absolute top-0 left-0 hidden h-full w-px bg-border/60 sm:left-[7.5rem] sm:block" />
							...
							<div className="flex flex-col gap-0">
								{TIMELINE.map(({ year, title, description }, i) => (
									...
									>
										...
										<div className="shrink-0 sm:w-28 sm:pt-0.5 sm:pr-8 sm:text-right">
											<span className="inline-block rounded-full bg-primary/10 px-3 py-1 font-bold text-primary text-xs sm:bg-transparent sm:p-0 sm:font-extrabold sm:text-foreground sm:text-sm">
												{year}
											</span>
										</div>

										{/* Dot on the line — sm only */}
										<div className="absolute top-1 left-[7.5rem] hidden h-3 w-3 -translate-x-1/2 rounded-full border-2 border-primary bg-background sm:block" />
					...
					<div className="mx-auto max-w-7xl px-4 sm:px-6">
						<div className="mb-7 text-center sm:mb-12">
							...
							<p className="mx-auto mt-2 max-w-xl text-muted-foreground text-sm sm:text-base">
								Kami adalah tim kecil yang bergerak cepat, dengan semangat besar
								untuk membangun produk yang benar-benar berguna.
							</p>
						</div>
						...
						<div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 lg:grid-cols-3">
							{TEAM.map(({ name, role, avatar, color, bio }) => (
								...
								>
									<div
										className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl ${color} font-bold text-sm text-white`}
									>
										{avatar}
									</div>
									<div className="min-w-0 flex-1">
										...
										<p className="mb-2 font-semibold text-primary text-xs">
											{role}
										</p>
						...
						<div className="mx-auto grid max-w-2xl grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
							{OFFICES.map(({ city, label, address, flag }) => (
								...
								>
									...
									<div>
										<p className="font-bold text-[10px] text-muted-foreground uppercase tracking-[0.12em]">
											{label}
										</p>
										<p className="font-bold text-sm sm:text-base">{city}</p>
				...
				<section className="border-border/60 border-t bg-muted/20 py-14 sm:py-24">
					<div className="mx-auto max-w-2xl px-4 text-center sm:px-6">
						...
						<p className="mb-8 text-muted-foreground text-sm sm:text-base">
							...
							infrastruktur digitalnya kepada kami. Mulai hari ini, tanpa
							risiko.
						</p>
