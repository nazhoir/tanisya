    ...
    <div className="min-w-0 space-y-5">
      {blocks.map((block, i) => {
        if (block.type === "paragraph") {
          return (
            <p key={i} className="break-words text-sm leading-7 text-foreground/90">
              {block.text}
            </p>
          );
        }
        ...
        if (block.type === "heading3") {
          return (
            <h3 key={i} className="mt-5 mb-1 font-semibold text-sm sm:text-base">
              {block.text}
            </h3>
          );
        }
        ...
        if (block.type === "callout") {
          ...
          const labels = { info: "ℹ Info", warning: "⚠ Perhatian", tip: "💡 Tips" };
          return (
            <div
              key={i}
...
function RelatedCard({ post }: { post: RelatedPost }) {
  return (
    <Link href={`/blog/${post.slug}`} className="block">
      <Card className="group overflow-hidden border-border transition-:">
        <div
        ...
        <CardHeader className="px-3 pt-3 pb-3 sm:px-4">
          ...
          <h4 className="min-w-0 break-words font-semibold text-xs leading-snug group-hover:text-primary transition-colors line-clamp-2">
            {post.title}
          </h4>
          ...
          <article className="min-w-0">
            ...
            <Card className="mb-5 overflow-hidden border-border ">
              <CardHeader className="px-4 pt-5 pb-5 sm:px-6">
                ...
                {/* Excerpt */}
                <p className="mt-2 wrap-break-word text-muted-foreground text-sm leading-relaxed">
                  {POST.excerpt}
                </p>
            ...
            <div className="mt-5 rounded-lg border bg-muted/20 px-4 py-4">
              <p className="mb-3 text-sm font-medium">Bagikan artikel ini</p>
                ...
                <CardContent className="px-4 pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="truncate font-semibold text-sm">{POST.author}</p>
              ...
              <Card className="border-border">
                ...
                <CardContent className="px-4 pb-4">
                  <ol className="space-y-2">
                    {toc.map((heading, i) => (
                      <li key={i}>
                        <button className="flex w-full items-start gap-2 text-left text-xs text-muted-foreground transition-colors hover:text-primary">
