	...
	return (
		<div className="bg-background">
			...
			<section className="border-b bg-linear-to-b from-primary/10 to-background">
				<div className="mx-auto max-w-5xl px-4 pb-16 pt-32 text-center">
					<div className="mb-8 md:mb-10">
						...
						<p className="mx-auto max-w-lg text-base text-muted-foreground md:text-lg">
							Temukan dan daftarkan nama domain impian Anda dengan harga terjangkau.
						</p>
					</div>
			...
			<section className="border-b bg-muted/20">
				<div className="mx-auto max-w-5xl px-4 py-10 md:py-12">
					<div className="mb-6 flex items-center gap-3">
						...
						<div>
							<h2 className="font-bold text-lg md:text-xl">Promo Domain Terbatas</h2>
							<p className="text-muted-foreground text-xs">
								Harga spesial untuk waktu terbatas. Daftarkan sekarang sebelum kehabisan.
							</p>
						</div>
					</div>
					<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
						{PROMOS.map((promo) => (
							<Card key={promo.tld} className="overflow-hidden pt-0 transition-shadow hover:shadow-md">
								<div className={`${promo.color} flex items-center justify-between px-4 py-2`}>
									<span className="font-semibold text-white text-xs">{promo.label}</span>
								...
								<CardContent className="p-4">
									<p className="mb-1 font-extrabold font-mono text-2xl text-primary">{promo.tld}</p>
									<div className="mb-0.5 flex items-baseline gap-1.5">
										<span className="font-bold text-xl">{formatIDR(promo.promoPrice)}</span>
			...
			*/}
			<section className="mx-auto max-w-5xl px-4 py-10">
				...
				<div className="grid grid-cols-1 gap-4 text-muted-foreground text-xs sm:grid-cols-2">
					<div className="flex items-start gap-2">
						...
						<p>
							<strong className="text-foreground">Catatan Harga:</strong> Harga berlaku untuk
							1 tahun pertama dan dapat berubah sewaktu-waktu.
						</p>
					</div>
					<div className="flex items-start gap-2">
						<span className="mt-0.5 text-base">💳</span>
						<p>
							<strong className="text-foreground">Metode Pembayaran:</strong> Transfer bank,
							kartu kredit/debit, QRIS, dan dompet digital.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="mx-auto max-w-5xl px-4 py-10">
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
					{[
						{ icon: Zap, title: "Aktivasi Instan", description: "Domain aktif dalam hitungan menit setelah pembayaran dikonfirmasi." },
						{ icon: ShieldCheck, title: "Keamanan Terjamin", description: "Privasi data terlindungi dengan enkripsi SSL dan WHOIS protection." },
						{ icon: HeadphonesIcon, title: "Dukungan Teknis", description: "Tim support siap membantu kapanpun Anda membutuhkan bantuan." },
					].map((f) => (
						<div
							key={f.title}
			...
			<section className="mx-auto max-w-2xl px-4 py-10 md:py-14">
				<div className="mb-8 text-center">
					<h2 className="mb-2 font-bold text-xl md:text-2xl">Pertanyaan Umum</h2>
