...
const AFFILIATE_FEATURES = [
  {
    ...
    description: "Pantau klik, konversi, dan earnings langsung dari satu dashboard yang clean dan intuitif.",
  },
  {
    icon: CreditCard,
    title: "Pencairan Fleksibel",
    description: "Transfer bank (BCA, Mandiri, BRI, BNI) atau GoPay & OVO. Tidak ada biaya admin pencairan.",
  },
  {
    icon: Gift,
    title: "Bonus Milestone",
    description: "Bonus tambahan setiap mencapai milestone referral. Semakin aktif, semakin besar bonusmu.",
  },
  {
    icon: Shield,
    title: "Cookie 90 Hari",
    description: "Tracking cookie berlaku 90 hari. Jika referralmu beli 3 bulan setelah klik, kamu tetap dapat komisi.",
  },
  {
    icon: Globe,
    title: "Materi Promosi Lengkap",
    description: "Banner, caption siap pakai, video penjelasan, dan studi kasus — semua tersedia untuk kamu download.",
  },
  {
    icon: TrendingUp,
    title: "Komisi Recurring",
    description: "Untuk mitra Pro, komisi terus mengalir setiap kali pelanggan referralmu memperpanjang layanan.",
  },
];
...
const NONPROFIT_TIERS = [
  {
    ...
    icon: Heart,
    discount: "50%",
    description: "Diskon 50% untuk yayasan dan LSM yang terdaftar secara legal di Indonesia.",
    requirements: ["Akta pendirian yayasan", "NPWP yayasan", "Surat keterangan aktif kegiatan"],
  },
  {
    org: "Komunitas & Forum",
    icon: Users,
    discount: "30%",
    description: "Diskon 30% untuk komunitas belajar, forum diskusi, dan kelompok kepentingan publik.",
    requirements: ["Deskripsi komunitas & aktivitas", "Bukti keaktifan (media sosial / grup)", "Minimal 50 anggota aktif"],
  },
  {
    org: "Lembaga Pendidikan",
    icon: Landmark,
    discount: "40%",
    description: "Diskon 40% untuk sekolah, universitas, pesantren, dan lembaga kursus non-komersial.",
    requirements: ["NPSN atau izin operasional", "Surat keterangan instansi", "Peruntukan non-komersial"],
  },
];
...
const NONPROFIT_BENEFITS = [
  {
    ...
    description: "Tidak ada persyaratan kontrak jangka panjang. Bayar bulanan dengan harga khusus.",
  },
  {
    icon: HeartHandshake,
    title: "Support Diprioritaskan",
    description: "Mitra non-profit mendapat prioritas support yang sama dengan pelanggan enterprise.",
  },
  {
    icon: Sparkles,
    title: "Konsultasi Teknis Gratis",
    description: "Sesi konsultasi setup 2 jam bersama tim teknis kami, gratis untuk mitra non-profit baru.",
  },
  {
    icon: Zap,
    title: "Perpanjangan Otomatis",
    description: "Kami kirimkan notifikasi perpanjangan 30 hari sebelumnya agar tidak ada gangguan layanan.",
  },
];
      ...
      <main className="w-full">
        ...
        <section className="relative flex min-h-[70svh] items-center">
          <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
            ...
            <div className="absolute right-0 top-1/4 h-40 w-40 rounded-full bg-amber-500/8 blur-[80px] sm:h-64 sm:w-64" />
          ...
          <div className="mx-auto w-full max-w-5xl px-4 pb-14 pt-24 sm:px-6 sm:pt-36">
            <div className="flex flex-col items-center text-center">
              <div className="mb-5 inline-flex max-w-full items-center gap-2 rounded-full border border-primary/25 bg-primary/5 px-3 py-1.5 text-xs font-semibold text-primary sm:mb-6 sm:px-4 sm:text-sm">
                ...
                <span className="truncate">Program Afiliasi · Partner B2B · Mitra Non-Profit</span>
              </div>
              ...
              <p className="mb-7 max-w-sm text-sm leading-relaxed text-muted-foreground sm:max-w-xl sm:text-base lg:text-lg">
                Rekomendasikan Tanisya dan dapatkan saldo akun otomatis — <strong className="text-foreground">Rp 15.000</strong> ketika referralmu daftar lalu beli produk pertamanya,
                ditambah <strong className="text-foreground">Rp 5.000</strong> flat untuk setiap transaksi berikutnya via link afiliasimu.
                Atau kolaborasi lebih dalam sebagai mitra B2B dan non-profit.
              </p>

              <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
                <a href="#afiliasi" className="w-full sm:w-auto">
                  <Button size="lg" className="h-12 w-full gap-2 px-6 text-sm font-bold shadow-lg shadow-primary/20 sm:px-8 sm:text-base">
                    Mulai Afiliasi <BadgePercent className="h-4 w-4 shrink-0" />
                  </Button>
                </a>
                <a href="#kerjasama" className="w-full sm:w-auto">
                  <Button size="lg" variant="outline" className="h-12 w-full gap-2 px-6 text-sm sm:px-8 sm:text-base">
                    Program Kerja Sama <ChevronRight className="h-4 w-4 shrink-0" />
                  </Button>
                </a>
              </div>
              ...
              <div className="mt-10 grid w-full grid-cols-2 gap-px overflow-hidden rounded-2xl border border-border/70 bg-border/25 sm:grid-cols-4">
                {HERO_STATS.map(({ value, label }) => (
                  <div key={label} className="flex flex-col items-center gap-0.5 bg-background/90 px-2 py-4 sm:px-6 sm:py-5">
                    <span className="text-xl font-extrabold tracking-tight sm:text-3xl">{value}</span>
        ...
        <section className="border-y border-border/60 bg-muted/20 py-12 sm:py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="mb-7 text-center sm:mb-12">
              <p className="mb-1.5 text-[11px] font-bold uppercase tracking-[0.15em] text-primary">Cara Kerja</p>
              <h2 className="text-xl font-extrabold tracking-tight sm:text-3xl">Mulai dapat komisi dalam 4 langkah</h2>
              <p className="mx-auto mt-2 max-w-lg text-sm text-muted-foreground sm:text-base">
                Tidak perlu keahlian teknis khusus. Siapapun bisa jadi afiliasi Tanisya.
              </p>
            </div>

            <div className="relative">
              <div className="absolute left-0 right-0 top-[2.75rem] hidden h-px bg-border/60 lg:block" />
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-0">
                {HOW_IT_WORKS.map(({ step, icon: Icon, title, description }) => (
                  <div key={step} className="relative flex flex-col items-start gap-3 lg:items-center lg:px-6 lg:text-center">
                    <div className="relative z-10 flex h-11 w-11 shrink-0 items-center justify-center rounded-full border-2 border-primary bg-background text-sm font-extrabold text-primary shadow-sm">
                      {step}
                    </div>
        ...
        <section id="afiliasi" className="py-12 sm:py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="mb-7 text-center sm:mb-12">
              <p className="mb-1.5 text-[11px] font-bold uppercase tracking-[0.15em] text-primary">Struktur Komisi</p>
              <h2 className="text-xl font-extrabold tracking-tight sm:text-3xl">Sederhana, flat, dan transparan</h2>
              <p className="mx-auto mt-2 max-w-lg text-sm text-muted-foreground sm:text-base">
                Tidak ada tier rumit, tidak ada syarat minimum. Kamu dapat saldo akun otomatis untuk setiap referral yang berhasil.
              </p>
            </div>

            {/* Two commission cards side by side */}
            <div className="mx-auto grid max-w-4xl grid-cols-1 gap-5 sm:grid-cols-2">
              {COMMISSION_CARDS.map(({ id, icon: Icon, label, amount, amountSub, color, accentBg, accentText, iconBg, description, perks }) => (
                <div key={id} className={`relative flex flex-col rounded-2xl border-2 bg-background p-6 ${color}`}>
                  {/* Header */}
                  <div className="mb-5 flex items-center gap-3">
                    <div className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl ${iconBg}`}>
                      <Icon className="h-5 w-5" />
                    </div>
                    <h3 className="text-sm font-extrabold leading-tight sm:text-base">{label}</h3>
                  </div>

                  {/* Amount highlight */}
                  <div className={`mb-5 rounded-xl p-5 ${accentBg}`}>
                    <div className={`text-5xl font-extrabold tracking-tight ${accentText}`}>{amount}</div>
                    <p className="mt-1 text-xs text-muted-foreground">{amountSub}</p>
                  </div>

                  {/* Description */}
                  <p className="mb-5 text-xs leading-relaxed text-muted-foreground sm:text-sm">{description}</p>
            ...
            <div className="mx-auto mt-5 max-w-4xl rounded-2xl border border-border/60 bg-muted/30 p-5 text-center sm:p-6">
              ...
              <p className="mb-5 text-xs text-muted-foreground sm:text-sm">
                Jika referralmu mendaftar lalu langsung beli produk, kamu dapat <strong className="text-foreground">Rp 15.000 (bonus daftar+beli) + Rp 5.000 (komisi transaksi) = Rp 20.000</strong> sekaligus.
              </p>
              <Link href="/affiliate/daftar">
                <Button className="h-10 gap-1.5 px-8 font-semibold shadow-md shadow-primary/15">
                  Daftar Afiliasi Sekarang — Gratis <ArrowRight className="h-3.5 w-3.5" />
                </Button>
              </Link>
            </div>
          </div>
        ...
        <section className="border-y border-border/60 bg-muted/20 py-12 sm:py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="mb-7 text-center sm:mb-12">
              <p className="mb-1.5 text-[11px] font-bold uppercase tracking-[0.15em] text-primary">Fitur Program</p>
              <h2 className="text-xl font-extrabold tracking-tight sm:text-3xl">Semua yang kamu butuhkan untuk sukses</h2>
            </div>

            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 lg:grid-cols-3">
              {AFFILIATE_FEATURES.map(({ icon: Icon, title, description }) => (
                <div key={title} className="flex items-start gap-4 rounded-2xl border border-border/60 bg-background p-5 transition-all hover:border-primary/30 hover:shadow-md">
        ...
        <section className="py-12 sm:py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="mb-7 text-center sm:mb-12">
              <p className="mb-1.5 text-[11px] font-bold uppercase tracking-[0.15em] text-primary">Kisah Sukses Afiliasi</p>
              <h2 className="text-xl font-extrabold tracking-tight sm:text-3xl">Mereka sudah membuktikannya</h2>
            </div>

            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-4">
              {AFFILIATE_TESTIMONIALS.map(({ name, role, avatar, color, earning, text }) => (
                <div key={name} className="flex flex-col gap-4 rounded-2xl border border-border/60 bg-background p-5">
                  <div className={`inline-flex w-fit items-center gap-1.5 rounded-full px-3 py-1 text-xs font-bold ${color} text-white`}>
        ...
        {/* ── KERJA SAMA B2B ───────────────────────────────────────────────── */}
        <section id="kerjasama" className="border-t border-border/60 bg-muted/20 py-12 sm:py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="mb-7 text-center sm:mb-12">
              <p className="mb-1.5 text-[11px] font-bold uppercase tracking-[0.15em] text-primary">Program B2B</p>
              <h2 className="text-xl font-extrabold tracking-tight sm:text-3xl">Kerja sama yang saling menguntungkan</h2>
              <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground sm:text-base">
                Lebih dari sekadar afiliasi — bangun bisnis bersama Tanisya sebagai mitra strategis
                dengan akses eksklusif, margin lebih tinggi, dan dukungan penuh.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
              {B2B_PLANS.map(({ icon: Icon, title, tag, tagColor, description, benefits, cta }) => (
                <div key={title} className="flex flex-col rounded-2xl border border-border/60 bg-background p-6 transition-all hover:border-primary/30 hover:shadow-md">
                  <div className="mb-4 flex items-start justify-between gap-3">
                    <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary/10 text-primary">
                      <Icon className="h-5 w-5" />
                    </div>
                    <span className={`rounded-full px-2.5 py-1 text-[10px] font-bold ${tagColor}`}>{tag}</span>
                  </div>

                  <h3 className="mb-2 text-base font-extrabold sm:text-lg">{title}</h3>
                  <p className="mb-4 text-xs leading-relaxed text-muted-foreground sm:text-sm">{description}</p>
                  ...
                  <Link href="/contact?ref=b2b">
                    <Button variant="outline" className="h-10 w-full gap-1.5 font-semibold">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <div className="mb-7 grid grid-cols-1 gap-8 lg:mb-12 lg:grid-cols-2 lg:items-end">
              <div>
                <div className="mb-2 flex flex-wrap items-center gap-2">
                  <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-emerald-600 dark:text-emerald-400">
                    Program Non-Profit
                  </p>
                ...
                <h2 className="text-xl font-extrabold tracking-tight sm:text-3xl">
                  Teknologi untuk semua — termasuk mereka yang melayani tanpa keuntungan
                </h2>
              </div>
              <p className="text-sm leading-relaxed text-muted-foreground sm:text-base">
                Kami percaya bahwa komunitas, yayasan, dan lembaga pendidikan adalah tulang punggung
                masyarakat. Program Non-Profit Tanisya hadir sebagai bentuk kontribusi nyata kami
                untuk mendukung misi sosial yang berarti.
              </p>
            </div>
            ...
            <div className="mb-8 grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 lg:grid-cols-4">
              {NONPROFIT_BENEFITS.map(({ icon: Icon, title, description }) => (
                <div key={title} className="flex items-start gap-4 rounded-2xl border border-emerald-200/70 bg-background p-5 transition-all hover:border-emerald-400/50 hover:shadow-md dark:border-emerald-900/60 sm:flex-col">
            ...
            <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
              {NONPROFIT_TIERS.map(({ org, icon: Icon, discount, description, requirements }) => (
                <div key={org} className="flex flex-col rounded-2xl border border-emerald-200/70 bg-background p-6 dark:border-emerald-900/60">
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-muted-foreground">Diskon untuk</p>
                      <h3 className="text-sm font-extrabold sm:text-base">{org}</h3>
                    </div>
                  </div>

                  <div className="mb-4 rounded-xl bg-emerald-50 p-4 dark:bg-emerald-500/5">
                    <div className="text-4xl font-extrabold tracking-tight text-emerald-600 dark:text-emerald-400">{discount}</div>
                    <p className="text-xs text-muted-foreground">dari harga normal</p>
                  </div>

                  <p className="mb-4 text-xs leading-relaxed text-muted-foreground sm:text-sm">{description}</p>

                  <div className="mb-5 flex-1">
                    <p className="mb-2 text-[11px] font-bold uppercase tracking-[0.1em] text-muted-foreground">Persyaratan:</p>
                    <ul className="flex flex-col gap-2">
                      {requirements.map((req) => (
                        <li key={req} className="flex items-start gap-2 text-xs text-muted-foreground sm:text-sm">
                  ...
                  <Link href="/contact?ref=nonprofit">
                    <Button variant="outline" className="h-10 w-full gap-1.5 border-emerald-300 font-semibold text-emerald-700 hover:bg-emerald-50 dark:border-emerald-800 dark:text-emerald-400 dark:hover:bg-emerald-950">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
              {NONPROFIT_TESTIMONIALS.map(({ name, role, avatar, color, text }) => (
                <div key={name} className="flex flex-col gap-4 rounded-2xl border border-emerald-200/70 bg-background p-5 dark:border-emerald-900/60">
              ...
              <div className="relative flex flex-col gap-7 p-6 sm:p-10 lg:flex-row lg:items-start lg:gap-12 lg:p-16">
                <div className="flex-1">
                  <div className="mb-4 inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3 py-1.5 text-xs font-bold">
                    <Sparkles className="h-3.5 w-3.5 shrink-0" /> PILIH PROGRAM YANG TEPAT UNTUKMU
                  </div>
                  ...
                  <p className="mb-6 text-sm leading-relaxed text-primary-foreground/80 sm:text-base">
                    Dari kreator konten, agensi digital, perusahaan teknologi, hingga yayasan sosial
                    — Tanisya punya jalur kemitraan yang sesuai dengan misi dan kapasitasmu.
                  </p>
                  <div className="flex flex-col gap-3 sm:flex-row">
                    ...
                    <Link href="/contact?ref=partner" className="w-full sm:w-auto">
                      <Button size="lg" variant="ghost" className="h-12 w-full gap-2 border border-white/20 text-primary-foreground hover:bg-white/10 sm:w-auto">
                        Diskusi Kemitraan <MessageCircle className="h-3.5 w-3.5" />
                      </Button>
                    </Link>
                  </div>
                </div>
                ...
                <div className="flex w-full flex-col gap-2 lg:w-72 lg:shrink-0">
                  {[
                    { icon: BadgePercent, label: "Afiliasi", sub: "Rp 15rb daftar · Rp 5rb per beli, flat" },
                    { icon: Building2,    label: "Reseller / B2B", sub: "Margin s.d. 40%, white-label" },
                    { icon: Globe,        label: "Tech Partner", sub: "API, integrasi, co-marketing" },
                    { icon: Heart,        label: "Non-Profit", sub: "Diskon 30–50%, tanpa syarat ribet" },
                  ].map(({ icon: Icon, label, sub }) => (
                    <div key={label} className="flex items-center gap-3 rounded-xl bg-white/10 px-3 py-2.5">
        ...
        {/* ── CTA ──────────────────────────────────────────────────────────── */}
        <section className="border-t border-border/60 py-14 sm:py-24">
          <div className="mx-auto max-w-2xl px-4 text-center sm:px-6">
            ...
            <p className="mb-8 text-sm text-muted-foreground sm:text-base">
              Tim partnership kami siap membantu kamu memilih program yang paling sesuai dan
              menjawab pertanyaan apapun — tanpa tekanan, tanpa commitment.
            </p>
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
              <Link href="/contact?ref=affiliate" className="w-full sm:w-auto">
                <Button size="lg" className="h-12 w-full gap-2 px-8 font-bold shadow-lg shadow-primary/20 sm:w-auto">
                  Hubungi Tim Partnership <ArrowRight className="h-4 w-4" />
                </Button>
              </Link>
              <a href="https://wa.me/6281234567890?text=Halo, saya tertarik dengan program kemitraan Tanisya" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="h-12 w-full gap-2 px-8 sm:w-auto">
