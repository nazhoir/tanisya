...
const DEPARTMENTS = [
	{
		...
		description:
			"Tanya soal produk, harga, atau minta demo. Tim sales kami siap membantu.",
	},
	{
		icon: Users,
		...
		description:
			"Masalah hosting, domain, SSL, atau layanan aktif. SLA respons 2 jam.",
	},
	{
		icon: HeartHandshake,
	...
	},
	{
		...
		description:
			"Kebutuhan skala besar, SLA khusus, dan dedicated infrastructure.",
	},
];
		...
		<>
			<main className="w-full">
				...
				<section className="relative flex min-h-[50svh] items-center">
					...
					<div className="mx-auto w-full max-w-5xl px-4 pt-24 pb-12 sm:px-6 sm:pt-36">
						<div className="flex flex-col items-center text-center">
							<div className="mb-5 inline-flex max-w-full items-center gap-2 rounded-full border border-primary/25 bg-primary/5 px-3 py-1.5 font-semibold text-primary text-xs sm:mb-6 sm:px-4 sm:text-sm">
								...
								<span className="truncate">
									Tim support aktif — rata-rata respons 5 menit
								</span>
							</div>
							...
							<p className="max-w-sm text-muted-foreground text-sm leading-relaxed sm:max-w-xl sm:text-base lg:text-lg">
								Tim Tanisya siap membantu kamu — dari konsultasi produk,
								pertanyaan teknis, hingga kerja sama bisnis. Pilih cara yang
				...
				{/* ── CHANNEL KONTAK ───────────────────────────────────────────────── */}
				<section className="border-border/60 border-y bg-muted/20 py-12 sm:py-16 lg:py-20">
					<div className="mx-auto max-w-7xl px-4 sm:px-6">
								...
								({
									...
									>
										<div className="flex items-start justify-between gap-3">
											...
											<span
												className={`rounded-full px-2.5 py-1 font-bold text-[10px] ${badgeColor}`}
											>
												{badge}
											</span>
										</div>
										...
										<div>
											...
											<p className="mt-0.5 font-semibold text-primary text-sm">
												{value}
											</p>
										</div>
						...
						<div className="mt-4 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-border/70 bg-border/25 sm:grid-cols-4">
							{RESPONSE_TIMES.map(({ channel, time, icon: Icon, color }) => (
								<div
									key={channel}
									className="flex flex-col items-center gap-1 bg-background/90 px-3 py-4 sm:px-6"
								>
					...
					<div className="mx-auto max-w-7xl px-4 sm:px-6">
						<div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-start lg:gap-14">
							...
							<div>
								...
								<h2 className="mb-1 font-extrabold text-xl leading-tight tracking-tight sm:text-3xl">
									Ceritakan kebutuhanmu
								</h2>
								<p className="mb-7 text-muted-foreground text-sm leading-relaxed sm:text-base">
									Isi form di bawah dan tim kami akan menghubungimu dalam waktu
									1×24 jam kerja.
								</p>
								...
								<form className="flex flex-col gap-4">
									...
									<div className="flex flex-col gap-1.5">
										...
										<div className="flex flex-wrap gap-2">
											{TOPICS.map((topic) => (
												<label
													key={topic}
													className="flex cursor-pointer items-center gap-1.5 rounded-full border border-border/60 bg-background px-3 py-1.5 font-semibold text-xs transition-all hover:border-primary/40 hover:bg-primary/5 has-[:checked]:border-primary has-[:checked]:bg-primary/10 has-[:checked]:text-primary"
												>
													<input
														type="radio"
														name="topic"
									...
									{/* Consent */}
									<label className="flex cursor-pointer items-start gap-2.5 text-muted-foreground text-xs">
										<input
											type="checkbox"
									...
									<Button
										type="submit"
										size="lg"
										className="h-12 w-full gap-2 font-bold shadow-md shadow-primary/15 sm:w-auto"
									>
										Kirim Pesan <Send className="h-4 w-4" />
									</Button>

									<p className="text-[11px] text-muted-foreground">
										Tidak ada spam. Data kamu aman dan tidak dibagikan ke pihak
										ketiga.
									</p>
								</form>
							</div>
							...
							<div className="flex flex-col gap-8">
								{/* Departemen */}
								<div>
									<p className="mb-4 font-bold text-[11px] text-primary uppercase tracking-[0.15em]">
								...
								<div>
									...
									<div className="flex flex-col gap-3">
										{OFFICES.map(
											({ city, label, address, city2, flag, maps }) => (
												<a
													key={city}
													href={maps}
													target="_blank"
												...
												>
													...
													<div className="min-w-0 flex-1">
														<div className="mb-0.5 flex items-center justify-between gap-2">
															<div>
																<p className="font-bold text-[10px] text-muted-foreground uppercase tracking-[0.1em]">
																	{label}
																</p>
								...
								<div className="rounded-2xl border border-border/60 bg-muted/30 p-5">
									<p className="mb-3 font-bold text-[11px] text-primary uppercase tracking-[0.15em]">
										Jam Operasional
									</p>
									...
									<div className="mt-3 flex items-center gap-1.5 rounded-xl bg-emerald-500/10 px-3 py-2 font-semibold text-emerald-600 text-xs dark:text-emerald-400">
										<span className="relative flex h-2 w-2 shrink-0">
							...
							<div className="relative flex flex-col gap-7 p-6 sm:p-10 lg:flex-row lg:items-center lg:gap-12 lg:p-16">
								<div className="flex-1">
									<div className="mb-4 inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3 py-1.5 font-bold text-xs">
										<Sparkles className="h-3.5 w-3.5 shrink-0" /> KONSULTASI
										GRATIS
									</div>
									...
									<p className="mb-6 text-primary-foreground/80 text-sm leading-relaxed sm:text-base">
										Tim teknis kami siap merekomendasikan solusi terbaik sesuai
										kebutuhan dan anggaran kamu — gratis, tanpa komitmen, dan
										tanpa tekanan untuk langsung beli.
									</p>
									<div className="flex flex-col gap-3 sm:flex-row">
										<a
											href="https://wa.me/6281234567890?text=Halo%2C%20saya%20ingin%20konsultasi%20gratis"
											target="_blank"
											rel="noopener noreferrer"
								...
								<div className="flex w-full flex-col gap-2 lg:w-72 lg:shrink-0">
									{[
										...
										{
											icon: CheckCircle2,
											text: "Tidak ada tekanan untuk beli",
										},
										{
											icon: CheckCircle2,
											text: "Rekomendasi dari tim teknis berpengalaman",
										},
										{
											icon: CheckCircle2,
											text: "Via WhatsApp, Zoom, atau tatap muka",
										},
										{
											icon: CheckCircle2,
											text: "Jadwal fleksibel sesuai waktumu",
										},
									].map(({ icon: Icon, text }) => (
										<div
											key={text}
					...
					<div className="mx-auto max-w-3xl px-4 sm:px-6">
						...
						<div className="flex flex-col gap-3">
							{[
								...
								>
									<h3 className="mb-2 font-bold text-sm sm:text-base">{q}</h3>
